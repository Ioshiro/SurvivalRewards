...
rewards[6] = {"Rewards.NightstickS" , "Rewards.CrowbarS" , "Rewards.MeatCleaverS" , "Base.ShotgunShellsBox"}
rewards[7] = {"MoneyToXP.MoneyStak" ,  "Rewards.LongJohnsFrodoL"}
rewards[8] = {"Rewards.SledgehammerS" , "Rewards.Machete20D" , "Rewards.Katana20D" }
rewards[9] = {"Rewards.Machete50D" , "Rewards.Katana50D"  , "Rewards.LongJohnsFrodoH" }
rewards[10] = {"Base.SpiffoBig" ,  "Rewards.Katana50D" , "Rewards.Jacket_PaddedRep" }
rewards[11] = {"Base.SpiffoBig" , "Rewards.SpearMacheteS" , "Rewards.LongJohnsFrodoH"}
